...
function initMap() {
    ...
    var myOptions = {
        content:
            "<p><i class='mb-icon mb-icon-pin'></i>16, Yafo Street, 94142 PARIS</p>" +
            "<p><i class='mb-icon mb-icon-phone'></i>(+972 2) 629 06 32</p>" +
            "<p><i class='mb-icon mb-icon-mail'></i>johndoe@gmail.com</p>",
...
function initMap2() {
    ...
    var myOptions = {
        content:
            "<p><i class='mb-icon mb-icon-pin'></i>Pennsylvania Ave NW, Washington, DC 20502, USA</p>" +
            "<p><i class='mb-icon mb-icon-phone'></i>(+972 2) 629 06 32</p>" +
            "<p><i class='mb-icon mb-icon-mail'></i>johndoe@gmail.com</p>",
        disableAutoPan: false,
        maxWidth: 0,
...
function initMap3() {
    ...
    var myOptions = {
        content:
            "<p><i class='mb-icon mb-icon-pin'></i>Singapore</p>" +
            "<p><i class='mb-icon mb-icon-phone'></i>(+972 2) 629 06 32</p>" +
            "<p><i class='mb-icon mb-icon-mail'></i>johndoe@gmail.com</p>",
        disableAutoPan: false,
        maxWidth: 0,
