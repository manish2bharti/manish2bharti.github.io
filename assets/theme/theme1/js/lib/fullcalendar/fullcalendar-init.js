...
/* ==========================================================================
    ...
    $('#calendar').fullCalendar({
        ...
        buttonIcons: {
            prev: 'mb-icon mb-icon-arrow-left',
            next: 'mb-icon mb-icon-arrow-right',
            prevYear: 'mb-icon mb-icon-arrow-left',
            nextYear: 'mb-icon mb-icon-arrow-right'
        },
            ...
            $('body').append(
                '<div class="fc-popover click">' +
                    '<div class="fc-header">' +
                        ...
                        '<button type="button" class="cl"><i class="mb-icon-close-2"></i></button>' +
                    '</div>' +
                    ...
                    '<div class="fc-body edit-event">' +
                        ...
                        '<div class="form-group">' +
                            '<div class="input-group date datetimepicker">' +
                                ...
                                '<span class="input-group-addon"><i class="mb-icon mb-icon-calend"></i></span>' +
                            '</div>' +
                        '</div>' +
                        '<div class="form-group">' +
                            '<div class="input-group date datetimepicker-2">' +
                                '<input type="text" class="form-control" />' +
                                '<span class="input-group-addon"><i class="mb-icon mb-icon-clock"></i></span>' +
                            '</div>' +
                        '</div>' +
                        '<div class="form-group">' +
